const { post } = require('../routes/category.route')
...
exports.findAll = async(req, res) => {
    ...
    try{
        ...
        console.log("Failure in getting categories")
    }
}

exports.create = async (req, res) => {
    const data = req.body
    console.log("Insert a post ", data.title)
    ...
    try{
        ...
        res.status(400).json({status : false, data: err})
        console.log("Failure in saving post")
    }
}
...
exports.findOne = async (req, res) => {
    ...
    try{
        ...
        res.status(400).json({status : false, data: err})
        console.log("Failure in finding post")
    }
}
