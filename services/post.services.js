...
function findOne(id) {
    const result = dataSource
        .getRepository(PostEntity)
        .createQueryBuilder('post')
        .leftJoinAndSelect('post.categoriess', 'category')
   ...
   async function updateCategory(data) {
        const actualRelationships = await dataSource
            ...
            const result = await dataSource
                ...
                .catch((error) => console.log("Cannot update categories"))
...
module.exports= { create, updatePost, findAll, findOne, updateCategory, deletePost, deleteCategories }